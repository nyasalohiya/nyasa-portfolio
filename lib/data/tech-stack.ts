...
export const techNodes: TechNode[] = [
  ...
  { id: "rag", name: "RAG", category: "AI & ML", connections: ["langgraph", "python", "langchain", "postgresql", "ssms"], x: 35, y: 60 },
  ...
  { id: "react", name: "React", category: "Core", connections: ["typescript"], x: 40, y: 70 },
  ...
  { id: "git", name: "Git", category: "Tools", connections: ["fastapi", "django", "postgresql", "python", "langgraph", "langchain", "rag", "typescript", "prompt-eng","graphrag"], x: 80, y: 25 }
];
